...
<span style="color:#3B528B">**Leclerc C.**</span>, Courchamp F. & Bellard C. (accepted). Vulnérabilité des milieux insulaires aux changements globaux. In A. Pomade *et al.* (Eds.), *Vulnérabilités environnementales : perspectives pluridisciplinaires*, L'Harmattan. [![BH](https://img.shields.io/badge/Book-L'Harmattan-21908C.svg)](https://www.editions-harmattan.fr/livre-vulnerabilite_s_environnementale_s_perspectives_pluridisciplinaires_rahma_bentirou_mathlouthi_adelie_pomade_sylvia_becerra-9782140344763-76799.html){:target="_blank"}<br>
